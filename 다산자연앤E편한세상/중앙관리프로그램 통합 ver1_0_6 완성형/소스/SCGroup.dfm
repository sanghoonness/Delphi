    ...
    object dgGroup: TDBAdvGrid
      ...
      Columns = <
        ...
        item
          ...
          Font.Name = #47569#51008' '#44256#46357
          Font.Style = []
          Header = #51221#44592#44428#44060#49688
          HeaderFont.Charset = ANSI_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -13
          HeaderFont.Name = #47569#51008' '#44256#46357
  ...
  object AdvPanel2: TAdvPanel
    ...
    object cmbBujae: TAdvComboBox
      ...
      Items.Strings = (
        #48120#51201#50857
        #51201#50857)
      LabelCaption = #48512#51228#51201#50857
      LabelPosition = lpLeftCenter
      LabelTransparent = True
      LabelAlwaysEnabled = True
      LabelFont.Charset = ANSI_CHARSET
    ...
    object edtCustInfo_WP: TAdvSpinEdit
      Left = 367
      Top = 12
      Width = 120
      Height = 22
      Value = 0
      DateValue = 44462.611435787040000000
      HexValue = 0
      Color = clSilver
      FocusColor = clAqua
      Font.Charset = ANSI_CHARSET
      ...
      IncrementFloatPage = 1.000000000000000000
      LabelAlwaysEnabled = True
      LabelCaption = #49324#50857#49884#44036#45824#48324' '#48264#54840
      LabelPosition = lpLeftCenter
      LabelTransparent = True
      LabelFont.Charset = ANSI_CHARSET
      LabelFont.Color = clWindowText
  ...
  object qryGroup: TADOQuery
    ...
    SQL.Strings = (
      'select t2.*, t1.cnt'
        ...
        'from (select GroupNo ,count(GroupNo) cnt from CustInfo group by ' +
        'GroupNo) as t1, ggroup t2'
      
        'where t1.groupno = t2.GroupNo and t2.ParkNo = 1 and t2.Reserve1 ' +
        'is null')
    Left = 56
    Top = 80
    ...
    object qryIONDataGroupBujaeType: TWordField
      FieldName = 'BujaeType'
    end
    object qryIONDataGroupRF1: TWordField
      FieldName = 'RF1'
    end
    object qryIONDataGroupRF2: TWordField
      FieldName = 'RF2'
    end
    object qryIONDataGroupRF3: TWordField
      FieldName = 'RF3'
    end
    object qryIONDataGroupRF4: TWordField
      FieldName = 'RF4'
    end
    object qryIONDataGroupRF5: TWordField
      FieldName = 'RF5'
    end
    object qryIONDataGroupRF6: TWordField
      FieldName = 'RF6'
    end
    object qryIONDataGroupRF7: TWordField
      FieldName = 'RF7'
    end
    object qryIONDataGroupRF8: TWordField
      FieldName = 'RF8'
    end
    object qryIONDataGroupRF9: TWordField
      FieldName = 'RF9'
    end
    object qryIONDataGroupRF10: TWordField
      FieldName = 'RF10'
    end
    object qryIONDataGroupRF11: TWordField
      FieldName = 'RF11'
    end
    object qryIONDataGroupRF12: TWordField
      FieldName = 'RF12'
    end
    object qryIONDataGroupRF13: TWordField
      FieldName = 'RF13'
    end
    object qryIONDataGroupRF14: TWordField
      FieldName = 'RF14'
    end
    object qryIONDataGroupRF15: TWordField
      FieldName = 'RF15'
    end
    object qryIONDataGroupRF16: TWordField
      FieldName = 'RF16'
    end
    object qryIONDataGroupRF17: TWordField
      FieldName = 'RF17'
    end
    object qryIONDataGroupRF18: TWordField
      FieldName = 'RF18'
    end
    object qryIONDataGroupRF19: TWordField
      FieldName = 'RF19'
    end
    object qryIONDataGroupRF20: TWordField
      FieldName = 'RF20'
    end
    object qryBlockLPRNo: TStringField
      FieldName = 'BlockLPRNo'
      Size = 50
    end
    object qryGroupcnt: TIntegerField
      FieldName = 'cnt'
      ReadOnly = True
    end
    object qryGroupWP: TIntegerField
      FieldName = 'WP'
    end
  end
