...
type
  TfrmIOSData = class(TForm)
    ...
    qryIOSDataParkingMin: TIntegerField;
    qryIOSDataOverParkingMin: TIntegerField;
    cmbType2: TComboBox;
    Bevel5: TBevel;
    Label6: TLabel;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if cmbType2.ItemIndex = 1 then
        begin
          SQL.Add(' and OverParkingMin =''0'' ');
        end
        else if cmbType2.ItemIndex = 2 then
        begin
          SQL.Add(' and OverParkingMin > ''0'' ');
        end;
      end
      ...
      begin
        ...
        while not eof do
        begin
           tdg1.cells[14, i] := IntToStr(FieldByName('ParkingMin').AsInteger div 60)+'시간('+FieldByName('ParkingMin').AsString+'분)';
           tdg1.cells[15, i] := IntToStr(FieldByName('OverParkingMin').AsInteger div 60)+'시간('+FieldByName('OverParkingMin').AsString+'분)';
           Inc(i);
           Next;
        end;
