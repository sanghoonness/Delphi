...
//  grdCarPossession.PrintSettings.TitleLines.Add('['+printStr + ' 현황]');
//  grdCarPossession.PrintSettings.TitleLines.Add(' ');
//
...
begin
  ...
  grdCarPossession.Columns[0].Header := '번호';
  grdCarPossession.Columns[1].Header := '동';
  grdCarPossession.Columns[2].Header := '호';
  grdCarPossession.Columns[3].Header := '전화번호';
  grdCarPossession.Columns[4].Header := '차량번호';
  grdCarPossession.Columns[5].Header := '등록일';
  ...
  grdCarPossession.Fonts[1,1].Name := '맑은 고딕';
  ...
  for i := 0 to grdCarPossession.ColCount-1 do begin
    ...
    grdCarPossession.Columns[i].HeaderFont.Name := '맑은 고딕';
