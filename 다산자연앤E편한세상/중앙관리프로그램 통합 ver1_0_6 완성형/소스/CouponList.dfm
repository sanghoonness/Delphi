object frmCouponList: TfrmCouponList
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #54624#51064#44428' '#48156#44553#45236#50669
  ClientHeight = 398
  ClientWidth = 834
  Color = clBtnFace
    ...
    object dg1: TDBAdvGrid
      ...
      Columns = <
        ...
        item
          ...
          CheckTrue = 'Y'
          Color = clWindow
          FieldName = 'CouponUnit'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #48156#44553#45800#44032
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #48156#44553#47588#49688
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #48156#44553#52509#50529
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #49884#51089#51068#47144#48264#54840
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #51333#47308#51068#47144#48264#54840
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
  ...
  object qryCouponSale: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * from CouponSale')
    Left = 56
    Top = 72
    object qryCouponSaleParkNo: TSmallintField
      FieldName = 'ParkNo'
    end
    object qryCouponSaleSaleDate: TStringField
      FieldName = 'SaleDate'
      FixedChar = True
      Size = 10
    end
    object qryCouponSaleSaleTime: TStringField
      FieldName = 'SaleTime'
      FixedChar = True
      Size = 8
    end
    object qryCouponSaleMNo: TSmallintField
      FieldName = 'MNo'
    end
    object qryCouponSaleMName: TStringField
      FieldKind = fkLookup
      FieldName = 'MName'
    ...
    object qryCouponSaleCompName: TStringField
      FieldName = 'CompName'
      Size = 50
    end
    object qryCouponSaleCouponUnit: TIntegerField
      FieldName = 'CouponUnit'
    end
    object qryCouponSaleCouponCnt: TIntegerField
      FieldName = 'CouponCnt'
    end
    object qryCouponSaleCouponAmt: TIntegerField
      FieldName = 'CouponAmt'
    end
    object qryCouponSaleReserve1: TStringField
      FieldName = 'Reserve1'
      Size = 50
    end
    object qryCouponSaleReserve2: TStringField
      FieldName = 'Reserve2'
      Size = 50
    end
    object qryCouponSaleReserve3: TStringField
      FieldName = 'Reserve3'
      OnGetText = qryCouponSaleReserve3GetText
      Size = 50
    end
    object qryCouponSaleReserve4: TStringField
      FieldName = 'Reserve4'
      OnGetText = qryCouponSaleReserve4GetText
      Size = 50
    end
    object qryCouponSaleReserve5: TStringField
      FieldName = 'Reserve5'
      Size = 50
    end
  end
  ...
  object dsCouponSale: TDataSource
    DataSet = qryCouponSale
    Left = 56
    Top = 132
  end
