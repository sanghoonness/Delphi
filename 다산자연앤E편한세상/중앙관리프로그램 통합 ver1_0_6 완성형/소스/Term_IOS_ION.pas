...
uses
  ...
  Data.DB, Data.Win.ADODB, tmsAdvGridExcel;

type
  TTerm_IOS_ION_Data = class(TForm)
    Title: TPanel;
    TitleDay: TPanel;
    TitleCount: TPanel;
    Panel1: TPanel;
    ...
    procedure TermCountSearch(ParkNo: Integer; ParkName: String);
...
var
  Term_IOS_ION_Data: TTerm_IOS_ION_Data;
...
procedure TTerm_IOS_ION_Data.btnCloseClick(Sender: TObject);
begin
    Close;
end;

procedure TTerm_IOS_ION_Data.btnExcelClick(Sender: TObject);
begin
  try
    ...
    on E: Exception do ExceptLogging('TTerm_IOS_ION.btnExcelClick: ' + E.Message);
  end;
end;

procedure TTerm_IOS_ION_Data.btnSearchClick(Sender: TObject);
var
   ParkNo : Integer;
   ParkName : string;
begin
     ...
     TermCountSearch(ParkNo, ParkName);
end;

procedure TTerm_IOS_ION_Data.FormShow(Sender: TObject);
begin
      edtSDate.Date := Now;
      edtEDate.Date := Now;
...
procedure TTerm_IOS_ION_Data.ParkNoSearch;
var
   ParkNo : Integer;
begin
...
procedure TTerm_IOS_ION_Data.TermCountSearch(ParkNo: Integer; ParkName: String);
var
  i : Byte;
begin
