...
begin
  try
    ...
    WriteINI2(PARK,'방문증차량 출차자동개방',edt1_OP17.ItemIndex);
    ...
    WriteINI2(PARK,'방화벽',                edt1_OP14.ItemIndex);
    ...
    WriteINI2(PARK,'휴일처리',              edt1_OP15.ItemIndex);
    WriteINI2(PARK,'웹할인',                edt1_OP16.ItemIndex);
    WriteINI2(PARK,'후면인식',              edt1_OP18.ItemIndex);
    WriteINI2(PARK,'방문증',                edt1_Visit1.ItemIndex);
    WriteINI2(PARK,'AutoVisitOpen',         edt1_Visit2.ItemIndex);
    WriteINI2(PARK,'방문증문구',            edt1_Visit15.ItemIndex);
    WriteINI(PARK,'방문증타이머',           edt1_Visit16.Text);
    WriteINI2(PARK,'방문증위치',            edt1_Visit17.ItemIndex);
    WriteINI2(PARK,'정기차량방문증',        edt1_Visit18.ItemIndex);
    ...
    WriteINI2(DSP,'보조전광판',            edt2_Default12.ItemIndex       );
    WriteINI2(DSP,'출구보조전광판',        edt2_Default17.ItemIndex       );

    WriteINI2(DSP,'전광판왼쪽이동',        edt2_Default13.ItemIndex       );
    WriteINI(DSP,'사전방문차량문구',       edt2_Default14.Text          );
    WriteINI(DSP,'기간만료문구',           edt2_Default18.Text          );
    ...
    WriteINI2(PARK,'홈넷날짜',                    edt4_home28.ItemIndex   );
    WriteINI(PARK,'홈넷기간',                     edt4_home29.Text   );
...
begin
  ...
  edt1_OP17.ItemIndex := ReadINI(PARK,'방문증차량 출차자동개방','');
  ...
  edt1_OP14.ItemIndex := ReadINI(PARK,'방화벽','');
  edt1_OP15.ItemIndex := ReadINI(PARK,'휴일처리','');
  edt1_OP16.ItemIndex := ReadINI(PARK,'웹할인','');
  edt1_OP18.ItemIndex := ReadINI(PARK,'후면인식','');

  edt1_Visit1.ItemIndex := ReadINI(PARK,'방문증','');
  edt1_Visit2.ItemIndex := ReadINI(PARK,'AutoVisitOpen','');
  edt1_Visit15.ItemIndex := ReadINI(PARK,'방문증문구','');
  edt1_Visit16.Text:= ReadINI(PARK,'방문증타이머','');
  edt1_Visit17.ItemIndex := ReadINI(PARK,'방문증위치','');
  edt1_Visit18.ItemIndex := ReadINI(PARK,'정기차량방문증','');
  ...
  edt2_Default12.ItemIndex := ReadINI(DSP,'보조전광판','');
  edt2_Default17.ItemIndex := ReadINI(DSP,'출구보조전광판','');
  edt2_Default13.ItemIndex := ReadINI(DSP,'전광판왼쪽이동','');
  edt2_Default14.Text := ReadINI(DSP,'사전방문차량문구','',1);
  edt2_Default18.Text := ReadINI(DSP,'기간만료문구','',1);
  ...
  edt4_home28.ItemIndex := ReadINI(PARK,'홈넷날짜','');
  edt4_home29.Text:= ReadINI(PARK,'홈넷기간','');
