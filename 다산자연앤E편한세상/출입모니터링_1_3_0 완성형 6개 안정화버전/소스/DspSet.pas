...
//      iSetup.WriteString('PARKING', 'DSP_' + IntToStr(i) + '_2', sDsp2);
      ...
      begin
        ...
        // 윗줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', '4_DSP_' + IntToStr(i) + '_1', sDsp1);
        iSetup.WriteString('DISPLAY', '4_DSP_' + IntToStr(i) + '_1', sDsp1);
        // 아랫줄문구
        sDsp2:= MG_MakeStr(MG_InsSpace(TAdvEdit(FindComponent('edt' + IntToStr(i) + '_2')).Text, 8));
        // 아랫줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', '4_DSP_' + IntToStr(i) + '_2', sDsp2);
        iSetup.WriteString('DISPLAY', '4_DSP_' + IntToStr(i) + '_2', sDsp2);
      end
      else
      begin
        // 윗줄문구
        ...
        // 윗줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', 'DSP_' + IntToStr(i) + '_1', sDsp1);
        iSetup.WriteString('DISPLAY', 'DSP_' + IntToStr(i) + '_1', sDsp1);
        // 아랫줄문구
        sDsp2:= MG_MakeStr(MG_InsSpace(TAdvEdit(FindComponent('edt' + IntToStr(i) + '_2')).Text, 12));
        // 아랫줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', 'DSP_' + IntToStr(i) + '_2', sDsp2);
        iSetup.WriteString('DISPLAY', 'DSP_' + IntToStr(i) + '_2', sDsp2);
      end;
...
//      iSetup.WriteString('PARKING', 'DSP_COLOR_' + IntToStr(i) + '_2', sColor2);
      if nDisplaySize = 0 then      //2단 4열
      begin
//        iSetup.WriteString('PARKING', '4_DSP_COLOR_' + IntToStr(i) + '_1', sColor1);
//        iSetup.WriteString('PARKING', '4_DSP_COLOR_' + IntToStr(i) + '_2', sColor2);
        iSetup.WriteString('DISPLAY', '4_DSP_COLOR_' + IntToStr(i) + '_1', sColor1);
        iSetup.WriteString('DISPLAY', '4_DSP_COLOR_' + IntToStr(i) + '_2', sColor2);
      end
      else
      begin
//        iSetup.WriteString('PARKING', 'DSP_COLOR_' + IntToStr(i) + '_1', sColor1);
//        iSetup.WriteString('PARKING', 'DSP_COLOR_' + IntToStr(i) + '_2', sColor2);
        iSetup.WriteString('DISPLAY', 'DSP_COLOR_' + IntToStr(i) + '_1', sColor1);
        iSetup.WriteString('DISPLAY', 'DSP_COLOR_' + IntToStr(i) + '_2', sColor2);
      end;
    end;
...
//    iSetup.WriteInteger('PARKING', 'DSP_TIME', edtTime.Value);
    iSetup.WriteInteger('DISPLAY', 'DSP_SPEED', edtSpeed.Value);
    iSetup.WriteInteger('DISPLAY', 'DSP_TIME', edtTime.Value);
    ShowMessage('출구전광판 문구설정을 저장완료하였습니다.');
  except
...
//      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', '4_DSP_1_1', ' ')), AnsiChar(39));
//      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', '4_DSP_1_2', ' ')), AnsiChar(39));
//      sColor1:= iSetup.ReadString('PARKING', '4_DSP_COLOR_1_1', '');
//      sColor2:= iSetup.ReadString('PARKING', '4_DSP_COLOR_1_2', '');
      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', '4_DSP_1_1', ' ')), AnsiChar(39));
      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', '4_DSP_1_2', ' ')), AnsiChar(39));
      sColor1:= iSetup.ReadString('DISPLAY', '4_DSP_COLOR_1_1', '');
      sColor2:= iSetup.ReadString('DISPLAY', '4_DSP_COLOR_1_2', '');
    end
    else
    begin
      nType:= 12;
//      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', 'DSP_1_1', ' ')), AnsiChar(39));
//      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', 'DSP_1_2', ' ')), AnsiChar(39));
//      sColor1:= iSetup.ReadString('PARKING', 'DSP_COLOR_1_1', '');
//      sColor2:= iSetup.ReadString('PARKING', 'DSP_COLOR_1_2', '');
      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', 'DSP_1_1', ' ')), AnsiChar(39));
      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', 'DSP_1_2', ' ')), AnsiChar(39));
      sColor1:= iSetup.ReadString('DISPLAY', 'DSP_COLOR_1_1', '');
      sColor2:= iSetup.ReadString('DISPLAY', 'DSP_COLOR_1_2', '');
    end;
...
//    edtTime.Value:= iSetup.ReadInteger('PARKING', 'DSP_TIME', 0);
    edtSpeed.Value:= iSetup.ReadInteger('DISPLAY', 'DSP_SPEED', 0);
    edtTime.Value:= iSetup.ReadInteger('DISPLAY', 'DSP_TIME', 0);
  except
