object frmIOAllData: TfrmIOAllData
  Left = 375
  Top = 251
  Caption = #51221#44592', '#51068#48152' '#52264#47049' '#52636#51077#45236#50669
  ClientHeight = 683
  ClientWidth = 1300
  Color = clBtnFace
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          item
            ...
            Title.Caption = #51077#52264#44592#44592
            Visible = True
          end
          item
            Expanded = False
  ...
  object qryIOAll: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    Left = 273
    Top = 129
    object qryIOAllInUnitName: TStringField
      FieldName = 'InUnitName'
    end
    object qryIOAllProcDate: TStringField
      FieldName = 'ProcDate'
    end
    object qryIOAllProcTime: TStringField
      FieldName = 'ProcTime'
    end
    object qryIOAllGroupName: TStringField
      FieldName = 'GroupName'
    end
    object qryIOAllname: TStringField
      FieldName = 'name'
    end
    object qryIOAllInCarNo1: TStringField
      FieldName = 'InCarNo1'
    end
    object qryIOAllOutUnitName: TStringField
      FieldName = 'OutUnitName'
    end
    object qryIOAllOutDate: TStringField
      FieldName = 'OutDate'
    end
    object qryIOAllOutTime: TStringField
      FieldName = 'OutTime'
    end
    object qryIOAllOutCarNo1: TStringField
      FieldName = 'OutCarNo1'
    end
    object qryIOAllCompName: TStringField
      FieldName = 'CompName'
    end
    object qryIOAllDeptName: TStringField
      FieldName = 'DeptName'
    end
    object qryIOAllCarType2: TStringField
      FieldName = 'CarType2'
    end
    object qryIOAllInImage1: TStringField
      FieldName = 'InImage1'
    end
    object qryIOAllOutImage1: TStringField
      FieldName = 'OutImage1'
    end
  end
  object dsIOAll: TDataSource
    DataSet = qryIOAll
    Left = 272
    Top = 184
  end
