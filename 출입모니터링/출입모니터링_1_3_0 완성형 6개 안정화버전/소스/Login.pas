...
begin
  try
    if cmbManager.Text <> adminManager then   //Modified LJH 190725 기본마스터ID 텍스트변경
    begin
      with qryManager do
      begin
        Close;
...
procedure TfrmLogin.edtPasswordKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then btnLogin.OnClick(Sender);
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        cmbManager.Items.Add(adminManager);         //Modified LJH 190725 기본마스터ID 텍스트변경
  ...
  try
      ...
      begin
        ...
        begin
          ...
          begin
            nManagerAuthority:= 0;
            nCurrMNo:= cmbManager.Tag;
            sCurrMName:= adminManager; // Modified by LJH 2019-07-25 14:42:43
            nLoginResult:= 1;
            Exit;
          end;
    ...
    begin
      ...
      begin
        nManagerAuthority:= 0;
        nCurrMNo:= cmbManager.Tag;
        sCurrMName:= adminManager; // Modified by LJH 2019-07-25 14:42:52
        nLoginResult:= 1;
      end;
    end;
  except
