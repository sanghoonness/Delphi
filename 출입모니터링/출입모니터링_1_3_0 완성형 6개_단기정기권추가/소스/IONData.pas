...
begin
  ...
  if isAPT = 0 then begin
    edtDong.LabelCaption := '회사:';
    edtHo.LabelCaption := '부서:';
    dg1.Columns[4].Header := '회사';
    dg1.Columns[5].Header := '부서';
  end else begin
    edtDong.LabelCaption := '동:';
    edtHo.LabelCaption := '호:';
    dg1.Columns[4].Header := '동';
    dg1.Columns[5].Header := '호';
  end;
