...
var
  ...
  sDBIP, sDBID, sDBPW, sDBName, sHostIP, sHostIP1: aString;  //DB IP
  ...
  bChkWeek : Boolean = True;        //미근무모드 설정 True : 유인운영 False : 무인운영
  bChkSat : Boolean = True;        //토요일근무모드 설정 True : 유인운영 False : 무인운영
  bChkSun : Boolean = True;        //일요일근무모드 설정 True : 유인운영 False : 무인운영
...
//  sDCOutTime, sPrtData, sProcTime, sPrtOutTime, sManualTKNo, sManualInTime: aString;
  sDCInTime,sDCOutTime, sPrtData, sProcTime, sPrtOutTime, sManualTKNo, sManualInTime: aString;
  ...
  sWeekSTime,sWeekETime ,sSatSTime,sSatETime,sSunSTime, sSunETime: aString;
