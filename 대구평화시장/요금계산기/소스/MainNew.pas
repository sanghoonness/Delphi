...
begin
  ...
  try
    ...
    begin
      ...
      SQL.Clear;
      SQL.Add('Select * from CustInfo ');
      SQL.Add('where CarNo = :N1 and ((ExpDateF <= :N3) and (ExpDateT >= :N4))');
      Parameters.ParamByName('N1').Value := sLostInCarNo;
      Parameters.ParamByName('N3').Value := FormatDateTime('YYYY-MM-DD', Now);
      Parameters.ParamByName('N4').Value := FormatDateTime('YYYY-MM-DD', Now);
      Open;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          sOrgFile:= Copy(sTemp, 1, Pos(':9080', sTemp)-1);
          sOrgFile:= sOrgFile + Copy(sTemp, Pos(':9080', sTemp)+5, Length(sTemp)-(Pos(':9080', sTemp)+4));
          sOrgFile:= MG_StrConvert(sOrgFile, '/', '\');
          sTempFile := sOrgFile;
          ExceptLogging('File: ' + sOrgFile);
        end
        else
        begin
          sTempFile := sOrgFile;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          case nNowCharo of
            1:                edtCharo.Color := clWhite;
            2:                edtCharo.Color := clYellow;
            3:                edtCharo.Color := clAqua;
          end;
    ...
    if (sInDate < '2016-03-01') or ((sInDate = '2016-03-01') and
...
//        end;
      ...
      begin
        ...
        begin
          ...
          begin
            // 할인처리후 유료출차
            Parameters.ParamByName('N16').Value := 8;
          end
          else
          begin
            // 무료출차
    ...
    if (nPayType= 1) and (nCashType = 0) then
    begin
