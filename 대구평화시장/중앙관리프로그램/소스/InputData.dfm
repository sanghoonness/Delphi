object frmInputData: TfrmInputData
  ...
  object dg1: TDBAdvGrid
    ...
    Columns = <
      ...
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Header = #50689#50629#50668#48512
        HeaderFont.Charset = DEFAULT_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -11
        HeaderFont.Name = 'Tahoma'
      ...
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Header = #54665#49324#50668#48512
        HeaderFont.Charset = DEFAULT_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -11
        HeaderFont.Name = 'Tahoma'
      ...
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Header = #47928#54868#54665#49324
        HeaderFont.Charset = DEFAULT_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -11
        HeaderFont.Name = 'Tahoma'
  ...
  object Panel2: TPanel
    ...
    object Label2: TLabel
      ...
      Height = 12
      Alignment = taCenter
      Caption = #50689#50629#50668#48512
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
      Font.Height = -12
      Font.Name = #44404#47548#52404
    ...
    object Label3: TLabel
      ...
      Height = 12
      Alignment = taCenter
      Caption = #54665#49324#50668#48512
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
      Font.Height = -12
      Font.Name = #44404#47548#52404
    ...
    object Label4: TLabel
      ...
      Height = 12
      Alignment = taCenter
      Caption = #47928#54868#54665#49324
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
      Font.Height = -12
      Font.Name = #44404#47548#52404
  ...
  object qryInputData: TADOQuery
    ...
    Left = 40
    Top = 24
    object qryInputDataParkNo: TSmallintField
      FieldName = 'ParkNo'
    end
    object qryInputDataProcDate: TStringField
      FieldName = 'ProcDate'
      FixedChar = True
      Size = 10
    end
    object qryInputDataYoill: TWordField
      FieldName = 'Yoill'
    end
    object qryInputDataCondition1: TWordField
      FieldName = 'Condition1'
      OnGetText = qryInputDataCondition1GetText
    end
    object qryInputDataCondition2: TStringField
      FieldName = 'Condition2'
      Size = 50
    end
    object qryInputDataCondition3: TStringField
      FieldName = 'Condition3'
      Size = 50
    end
    object qryInputDataCondition4: TStringField
      FieldName = 'Condition4'
      Size = 50
    end
    object qryInputDataReserve1: TStringField
      FieldName = 'Reserve1'
      Size = 50
    end
    object qryInputDataReserve2: TStringField
      FieldName = 'Reserve2'
      Size = 50
    end
    object qryInputDataReserve3: TStringField
      FieldName = 'Reserve3'
      Size = 50
    end
    object qryInputDataReserve4: TStringField
      FieldName = 'Reserve4'
      Size = 50
    end
    object qryInputDataReserve5: TStringField
      FieldName = 'Reserve5'
      Size = 50
    end
  end
  object dsInputData: TDataSource
    DataSet = qryInputData
    Left = 40
    Top = 80
  end
