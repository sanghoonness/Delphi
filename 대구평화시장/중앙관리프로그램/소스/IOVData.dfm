object frmIOVData: TfrmIOVData
  Left = 482
  Top = 188
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #48156#47131#52264#47049' '#51077#52636#45236#50669
  ClientHeight = 486
  ClientWidth = 877
  Color = clBtnFace
    ...
    object dg1: TDBAdvGrid
      ...
      Columns = <
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #48156#47131#50668#48512
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -12
          HeaderFont.Name = #44404#47548#52404
        ...
        item
          ...
          CheckTrue = 'Y'
          Color = clWindow
          FieldName = 'ValetStatus'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #48156#47131#49345#53468
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -12
          HeaderFont.Name = #44404#47548#52404
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #49688#51221#51068#51088
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -12
          HeaderFont.Name = #44404#47548#52404
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #49688#51221#49884#44033
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -12
          HeaderFont.Name = #44404#47548#52404
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #52636#52264#50836#52397#50948#52824
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -12
          HeaderFont.Name = #44404#47548#52404
  ...
  object Panel2: TPanel
    ...
    object Label2: TLabel
      ...
      Height = 12
      Alignment = taCenter
      Caption = #48156#47131#49345#53468
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
      Font.Height = -12
      Font.Name = #44404#47548#52404
    ...
    object cmbValStatus: TComboBox
      ...
      Items.Strings = (
        #51204#52404
        #51077#52264#50756#47308
        #52636#52264#50836#52397
        #52636#52264#51217#49688
        #52636#52264#50756#47308
        #44256#44061#51064#44228)
    end
  ...
  object edtTotal: TPanel
    ...
    Caption = ' '#52509#51077#52264': 0'#44148' '#52509#44256#44061#51064#44228': 0'#44148' '
    TabOrder = 6
  end
  ...
  object qryIOVData: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * from ValDataProc')
    Left = 48
    Top = 76
    object qryIOVDataParkNo: TSmallintField
      FieldName = 'ParkNo'
    end
    object qryIOVDataUnitNo: TSmallintField
      FieldName = 'UnitNo'
    end
    object qryIOVDataProcDate: TStringField
      FieldName = 'ProcDate'
      FixedChar = True
      Size = 10
    end
    object qryIOVDataProcTime: TStringField
      FieldName = 'ProcTime'
      FixedChar = True
      Size = 8
    end
    object qryIOVDataTKNo: TStringField
      FieldName = 'TKNo'
      Size = 50
    end
    object qryIOVDataName: TStringField
      FieldName = 'Name'
      Size = 50
    end
    object qryIOVDataInCarNo: TStringField
      FieldName = 'InCarNo'
      Size = 50
    end
    object qryIOVDataOutDate: TStringField
      FieldName = 'OutDate'
      FixedChar = True
      Size = 10
    end
    object qryIOVDataOutTime: TStringField
      FieldName = 'OutTime'
      FixedChar = True
      Size = 8
    end
    object qryIOVDataCardNo: TStringField
      FieldName = 'CardNo'
      Size = 50
    end
    object qryIOVDataValetChk: TWordField
      FieldName = 'ValetChk'
      OnGetText = qryIOVDataValetChkGetText
    end
    object qryIOVDataValetStatus: TWordField
      FieldName = 'ValetStatus'
      OnGetText = qryIOVDataValetStatusGetText
    end
    object qryIOVDataUpdateDate: TStringField
      FieldName = 'UpdateDate'
      FixedChar = True
      Size = 10
    end
    object qryIOVDataUpdateTime: TStringField
      FieldName = 'UpdateTime'
      FixedChar = True
      Size = 8
    end
    object qryIOVDataReserve1: TStringField
      FieldName = 'Reserve1'
      Size = 50
    end
    object qryIOVDataReserve2: TStringField
      FieldName = 'Reserve2'
      Size = 50
    end
    object qryIOVDataReserve3: TStringField
      FieldName = 'Reserve3'
      Size = 50
    end
    object qryIOVDataReserve4: TStringField
      FieldName = 'Reserve4'
      Size = 50
    end
    object qryIOVDataReserve5: TStringField
      FieldName = 'Reserve5'
      Size = 50
    end
    object qryIOVDataUpdateManager: TStringField
      FieldName = 'UpdateManager'
      Size = 50
    end
  end
  object dsIOVData: TDataSource
    DataSet = qryIOVData
    Left = 120
    Top = 76
  end
