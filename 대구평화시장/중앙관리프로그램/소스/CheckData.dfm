object frmCheckData: TfrmCheckData
  Left = 0
  Top = 0
  ...
  object Panel2: TPanel
    ...
    object cmbIO: TComboBox
      ...
      ItemIndex = 0
      TabOrder = 1
      Text = #45236#48169#54943#49688
      OnChange = cmbIOChange
      Items.Strings = (
        #45236#48169#54943#49688
        #44396#47588#44552#50529)
    end
  end
  ...
  object dg1: TDBAdvGrid
    ...
    Columns = <
      ...
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Header = #45236#48169#54943#49688
        HeaderFont.Charset = DEFAULT_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -11
        HeaderFont.Name = 'Tahoma'
  ...
  object qryData: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Select ProcDate, InCarNo1, isnull(Count(*), 0) sData from iosdat' +
        'a group by procDate, InCarNo1')
    Left = 160
    Top = 32
    object qryDataProcDate: TStringField
      FieldName = 'ProcDate'
      FixedChar = True
      Size = 10
    end
    object qryDataInCarNo1: TStringField
      FieldName = 'InCarNo1'
      Size = 50
    end
    object qryDatasData: TIntegerField
      FieldName = 'sData'
      ReadOnly = True
    end
  end
