...
begin
  ...
  begin
    ...
    SQL.Clear;
    //SQL.Add('Select * from IONData where OutChk = 0 and ProcDate = :N1 and ((InRecog1 > 1) or (InRecog2 > 1))');
    SQL.Add('Select * from IONData where OutChk = 0 and ProcDate = :N1 and ((InRecog1 > 1) and (InRecog2 > 1))');
    Parameters.ParamByName('N1').Value:= FormatDateTime('YYYY-MM-DD', edtDate.Date);
    Open;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          begin
            sInFile:= qryIONData.FieldByName('InImage1').AsString;
          end;
