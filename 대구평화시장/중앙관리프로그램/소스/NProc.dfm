object frmNProc: TfrmNProc
  ...
  object DBAdvGrid1: TDBAdvGrid
    ...
    Columns = <
      ...
      item
        ...
        Font.Name = #44404#47548#52404
        Font.Style = []
        Header = #49892#54624#51064#44552#50529
        HeaderFont.Charset = ANSI_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -12
        HeaderFont.Name = #44404#47548#52404
  ...
  object Panel1: TPanel
    ...
    object Label5: TLabel
      ...
      Height = 12
      Alignment = taCenter
      Caption = #54624#51064#51333#47448
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
      Font.Height = -12
      Font.Name = #44404#47548#52404
    ...
    object Label6: TLabel
      ...
      Height = 12
      Alignment = taCenter
      Caption = #51221#49328#51333#47448
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
      Font.Height = -12
      Font.Name = #44404#47548#52404
    ...
    object cmbDCType: TComboBox
      ...
      Items.Strings = (
        #51204#52404
        #48376#49324#44277#53685#54624#51064
        'POS'#54624#51064
        #49688#46041#54624#51064)
    end
    object cmbOutChk: TComboBox
      Left = 82
      Top = 38
      Width = 93
      Height = 20
  ...
  object Panel2: TPanel
    ...
    object Label9: TLabel
      ...
      Height = 12
      Alignment = taCenter
      Caption = #52509#48155#51008#44552#50529
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
      Font.Height = -12
      Font.Name = #44404#47548#52404
  ...
  object qryTKProc: TADOQuery
    ...
    SQL.Strings = (
      ...
      '              ,a.ProcTime'
      '              ,a.FeeNo'
      '              ,Case a.FeeNo when 0 then '#39#51068#48152#50836#44552#39
      '               else d.FeeName'
      '               end FeeName'
      '              ,Case a.TKType When 1 Then '#39#51068#48152#52264#47049#39
      '                             When 2 Then '#39#51221#44592#52264#47049#39
      '                             When 9 Then '#39#49688#46041#52636#52264#39
      '               END TKType'
      '              ,a.CarNo'
      '              ,a.TKUnitNo'
      '              ,b.UnitName'
      ...
      '              ,a.DCCnt'
      '             , a.reserve2'
      '              ,Case a.PayType When 1 Then '#39#54788#44552#39
      '                            When 2 Then '#39#49888#50857#52852#46300#39
      '               End PayType'
      ...
      '                        ON a.FeeNo    = D.FeeNo'
      '         WHERE a.ProcDate = '#39'2012-08-07'#39
      '        )A  Left Outer Join'
      '       (SELECT A.ParkNo'
      '              ,A.UnitNo'
      '              ,A.ProcDate'
      '              ,A.ProcTime'
      '              ,A.DcNo'
      '              ,Case A.DCNo when 0 then '#39#54624#51064#44428#54624#51064#39
      '               else B.DCNAME'
      '               end DCName'
      '              ,Sum(DCAmt) DCAmt'
      ...
      '         WHERE A.PROCDate = '#39'2012-08-07'#39
        ...
        '         GROUP BY A.ParkNo, A.UnitNo, A.ProcDate, A.ProcTime, A.' +
        'DcNo, B.DCNAME'
      '       ) B'
    ...
    object qryTKProcTkType: TStringField
      FieldName = 'TkType'
      Size = 8
    end
    ...
    object qryTKProcMName: TStringField
      FieldName = 'MName'
      Size = 50
    end
    object qryTKProcPayType: TStringField
      FieldName = 'PayType'
      Size = 8
    end
    object qryTKProcDCNAME: TStringField
      FieldName = 'DCNAME'
      Size = 50
    end
    object qryTKProcDCCnt: TIntegerField
      FieldName = 'DCCnt'
    end
    object qryTKProcRealDCAmt: TIntegerField
      FieldName = 'RealDCAmt'
    end
    ...
    object qryTKProcInUnitName: TStringField
      FieldKind = fkLookup
      FieldName = 'InUnitName'
      LookupDataSet = dmTables.qryUnitInfo
