object frmGracetime: TfrmGracetime
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = #49436#48708#49828#49884#44036' '#49444#51221
  ClientHeight = 418
  ClientWidth = 681
  Color = clBtnFace
    ...
    object dgGracetime: TDBAdvGrid
      ...
      Columns = <
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #54924#52264#49884#44036
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #51221#49328#54980#52636#52264#49884#44036
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #53664#50836#51068#54924#52264#49884#44036
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #51068#50836#51068#54924#52264#49884#44036
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #51221#44592#52264#47049#54728#50857#51068#49688
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
  ...
  object AdvPanel2: TAdvPanel
    ...
    object edtGT1: TAdvMaskEdit
      ...
      LabelCaption = #54924#52264#49884#44036
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT2: TAdvMaskEdit
      ...
      FocusBorder = False
      FocusFontColor = clBlack
      LabelCaption = #51221#49328#54980#52636#52264#49884#44036
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT3: TAdvMaskEdit
      ...
      FocusBorder = False
      FocusFontColor = clBlack
      LabelCaption = #53664#50836#51068#54924#52264#49884#51089#49884#44033
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT4: TAdvMaskEdit
      ...
      FocusBorder = False
      FocusFontColor = clBlack
      LabelCaption = #53664#50836#51068#54924#52264#51333#47308#49884#44033
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT5: TAdvMaskEdit
      ...
      FocusBorder = False
      FocusFontColor = clBlack
      LabelCaption = #53664#50836#51068#54924#52264#49884#44036
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT6: TAdvMaskEdit
      ...
      FocusBorder = False
      FocusFontColor = clBlack
      LabelCaption = #51068#50836#51068#54924#52264#49884#51089#49884#44033
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT7: TAdvMaskEdit
      ...
      FocusBorder = False
      FocusFontColor = clBlack
      LabelCaption = #51068#50836#51068#54924#52264#51333#47308#49884#44033
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT8: TAdvMaskEdit
      ...
      FocusBorder = False
      FocusFontColor = clBlack
      LabelCaption = #51068#50836#51068#54924#52264#49884#44036
      LabelAlwaysEnabled = True
      LabelPosition = lpLeftCenter
      LabelMargin = 4
      LabelTransparent = True
    ...
    object edtGT9: TAdvSpinEdit
      Left = 364
      Top = 113
      Width = 80
      Height = 21
      Value = 0
      DateValue = 41006.677532187500000000
      HexValue = 0
      Enabled = True
      FocusColor = clAqua
      Font.Charset = ANSI_CHARSET
      ...
      LabelAlwaysEnabled = True
      LabelCaption = #44592#44036#47564#47308' '#51221#44592#52264#47049' '#52636#51077#54728#50857#51068#49688
      LabelPosition = lpLeftCenter
      LabelTransparent = True
      LabelFont.Charset = ANSI_CHARSET
      LabelFont.Color = clWindowText
  ...
  object qryGracetime: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * from Gracetime'
      ''
      '')
    Left = 48
    Top = 96
    object qryGracetimeParkNo: TSmallintField
      FieldName = 'ParkNo'
    end
    object qryGracetimeGT1: TStringField
      FieldName = 'GT1'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT2: TStringField
      FieldName = 'GT2'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT3: TStringField
      FieldName = 'GT3'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT4: TStringField
      FieldName = 'GT4'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT5: TStringField
      FieldName = 'GT5'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT6: TStringField
      FieldName = 'GT6'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT7: TStringField
      FieldName = 'GT7'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT8: TStringField
      FieldName = 'GT8'
      FixedChar = True
      Size = 5
    end
    object qryGracetimeGT9: TWordField
      FieldName = 'GT9'
    end
    object qryGracetimeReserve1: TStringField
      FieldName = 'Reserve1'
      Size = 50
    end
    object qryGracetimeReserve2: TStringField
      FieldName = 'Reserve2'
      Size = 50
    end
    object qryGracetimeReserve3: TStringField
      FieldName = 'Reserve3'
      Size = 50
    end
    object qryGracetimeReserve4: TStringField
      FieldName = 'Reserve4'
      Size = 50
    end
    object qryGracetimeReserve5: TStringField
      FieldName = 'Reserve5'
      Size = 50
    end
  end
  object dsGracetime: TDataSource
    DataSet = qryGracetime
    Left = 48
    Top = 152
  end
