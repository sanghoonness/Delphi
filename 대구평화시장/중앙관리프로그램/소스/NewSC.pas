...
begin
  try
    ...
    begin
      ...
      // 등록 로그
      ExceptLogging('TfrmNewSC.btnSaveClick # 그룹번호: ' + cmbGroupNo.Text + ', 차량번호: ' + edtCarNo.Text
                  + ', 유효기간시작: ' + DateToStr(edtExpDateF.Date) + ', 유효기간끝: ' + DateToStr(edtExpDateT.Date) + ', 발급금액: ' + IntToStr(edtAmount.Value) + '원');
