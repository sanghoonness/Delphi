...
type
  TfrmMonthlyReport = class(TForm)
    ...
    qryTKProcClosingMCOLUMN11: TIntegerField;
    qryTKProcClosingMCOLUMN12: TIntegerField;
    qryTKProcClosingMCOLUMN13: TIntegerField;
    qryTKProcClosingMCOLUMN14: TIntegerField;
    Bevel16: TBevel;
    Label16: TLabel;
    edtHyunCnt: TAdvEdit;
    edtHyunAmt: TAdvEdit;
...
begin
  try
    ...
    begin
      ...
      SQL.Add(',Sum(convert(int, reserve1)), Sum(convert(int, reserve2)), Sum(convert(int, reserve3)), Sum(convert(int, reserve4)) ');
      ...
      begin
        ...
        begin
          ...
          edtHyunCnt  .Text := FieldByName('COLUMN11').AsString;
          edtHyunAmt  .Text := FieldByName('COLUMN12').AsString;
          edtCreditCnt.Text := FieldByName('COLUMN13').AsString;
          edtCreditAmt.Text := FieldByName('COLUMN14').AsString;
