...
//      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', '4_IN_DSP_1_1', ' ')), AnsiChar(39));
//      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', '4_IN_DSP_1_2', ' ')), AnsiChar(39));
//      sColor1:= iSetup.ReadString('PARKING', '4_IN_DSP_COLOR_1_1', '');
//      sColor2:= iSetup.ReadString('PARKING', '4_IN_DSP_COLOR_1_2', '');
      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', '4_IN_DSP_1_1', ' ')), AnsiChar(39));
      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', '4_IN_DSP_1_2', ' ')), AnsiChar(39));
    ...
    begin
      nType:= 12;
//      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', 'IN_DSP_1_1', ' ')), AnsiChar(39));
//      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', 'IN_DSP_1_2', ' ')), AnsiChar(39));
//      sColor1:= iSetup.ReadString('PARKING', 'IN_DSP_COLOR_1_1', '');
//      sColor2:= iSetup.ReadString('PARKING', 'IN_DSP_COLOR_1_2', '');
      TAdvEdit(FindComponent('edt1_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', 'IN_DSP_1_1', ' ')), AnsiChar(39));
      TAdvEdit(FindComponent('edt1_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('DISPLAY', 'IN_DSP_1_2', ' ')), AnsiChar(39));
    ...
    for i:= 1 to 1 do
    begin
//      TAdvEdit(FindComponent('edt' + IntToStr(i) + '_1')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', 'IN_DSP_' + IntToStr(i) + '_1', ' ')), AnsiChar(39));
//      TAdvEdit(FindComponent('edt' + IntToStr(i) + '_2')).Text:= MG_StrTrim(aString(iSetup.ReadString('PARKING', 'IN_DSP_' + IntToStr(i) + '_2', ' ')), AnsiChar(39));
//      sColor1:= iSetup.ReadString('PARKING', 'IN_DSP_COLOR_' + IntToStr(i) + '_1', '');
//      sColor2:= iSetup.ReadString('PARKING', 'IN_DSP_COLOR_' + IntToStr(i) + '_2', '');
...
//    edtSpeed.Value:= iSetup.ReadInteger('PARKING', 'IN_DSP_SPEED', 0);
//    edtTime.Value:= iSetup.ReadInteger('PARKING', 'IN_DSP_TIME', 0);
    edtSpeed.Value:= iSetup.ReadInteger('DISPLAY', 'IN_DSP_SPEED', 0);
    edtTime.Value:= iSetup.ReadInteger('DISPLAY', 'IN_DSP_TIME', 0);
  except
    on E: Exception do ExceptLogging('TfrmInDspSet.FormShow: ' + aString(E.Message));
  end;
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        // 윗줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', '4_IN_DSP_' + IntToStr(i) + '_1', sDsp1);
        ...
        // 아랫줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', '4_IN_DSP_' + IntToStr(i) + '_2', sDsp2);
      ...
      begin
        ...
        // 윗줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', 'IN_DSP_' + IntToStr(i) + '_1', sDsp1);
        ...
        // 아랫줄문구 가져와서 ini파일에 저장
//        iSetup.WriteString('PARKING', 'IN_DSP_' + IntToStr(i) + '_2', sDsp2);
      ...
      if nDisplaySize = 0 then      //2단 4열
      begin
//        iSetup.WriteString('PARKING', '4_IN_DSP_COLOR_' + IntToStr(i) + '_1', sColor1);
//        iSetup.WriteString('PARKING', '4_IN_DSP_COLOR_' + IntToStr(i) + '_2', sColor2);
      ...
      begin
//        iSetup.WriteString('PARKING', 'IN_DSP_COLOR_' + IntToStr(i) + '_1', sColor1);
//        iSetup.WriteString('PARKING', 'IN_DSP_COLOR_' + IntToStr(i) + '_2', sColor2);
    ...
    // 전광판 표출속도, 표출시간 ini파일에 저장
    iSetup.WriteInteger('DISPLAY', 'IN_DSP_SPEED', edtSpeed.Value);
    iSetup.WriteInteger('DISPLAY', 'IN_DSP_TIME', edtTime.Value);
//    iSetup.WriteInteger('PARKING', 'IN_DSP_SPEED', edtSpeed.Value);
//    iSetup.WriteInteger('PARKING', 'IN_DSP_TIME', edtTime.Value);
    ShowMessage('입구전광판 문구설정을 저장완료하였습니다.');
  except
