object dmTables: TdmTables
  ...
  object qryRecvOutLpr4: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    Left = 544
  ...
  object qryOutLpr4Proc: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    Left = 624
  ...
  object qryNormalOut3: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    Left = 592
  ...
  object qryInsertBlackList: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    Left = 543
  ...
  object qryVisitInsert: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    Left = 704
  ...
  object qryVisitDelete: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    Left = 704
  ...
  object dsNomalCar: TDataSource
    DataSet = qryNomalCar
    Left = 704
    Top = 136
  end
  object qryNomalCar: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'Select top 100 ProcDate, ProcTime, InCarNo1, OutDate, OutTime, R' +
        'eserve2, Reserve3, Reserve1'
      'From iondata')
    Left = 704
    Top = 80
  end
