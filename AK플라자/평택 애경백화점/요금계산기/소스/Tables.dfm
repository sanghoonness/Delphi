object dmTables: TdmTables
  ...
  object ADODB: TADOConnection
    ConnectionString = 
      'Provider=SQLOLEDB.1;Password=dbuser;Persist Security Info=True;U' +
      'ser ID=parking_user;Initial Catalog=PARKING;Data Source=127.0.0.' +
      '1'
    LoginPrompt = False
    Provider = 'SQLOLEDB.1'
    Left = 32
  ...
  object qrySCNormal: TADOQuery
    Connection = ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select top 1 * from IOSData')
    Left = 480
    Top = 432
    object qrySCNormalParkNo: TSmallintField
      FieldName = 'ParkNo'
    end
    object qrySCNormalUnitNo: TSmallintField
      FieldName = 'UnitNo'
    end
    object qrySCNormalProcDate: TStringField
      FieldName = 'ProcDate'
      FixedChar = True
      Size = 10
    end
    object qrySCNormalProcTime: TStringField
      FieldName = 'ProcTime'
      FixedChar = True
      Size = 8
    end
    object qrySCNormalTKNo: TStringField
      FieldName = 'TKNo'
      Size = 50
    end
    object qrySCNormalTKType: TWordField
      FieldName = 'TKType'
    end
    object qrySCNormalCarType: TWordField
      FieldName = 'CarType'
    end
    object qrySCNormalGroupNo: TSmallintField
      FieldName = 'GroupNo'
    end
    object qrySCNormalGroupName: TStringField
      FieldName = 'GroupName'
      Size = 50
    end
    object qrySCNormalCompName: TStringField
      FieldName = 'CompName'
      Size = 50
    end
    object qrySCNormalDeptName: TStringField
      FieldName = 'DeptName'
      Size = 50
    end
    object qrySCNormalName: TStringField
      FieldName = 'Name'
      Size = 50
    end
    object qrySCNormalInImage1: TStringField
      FieldName = 'InImage1'
      Size = 300
    end
    object qrySCNormalInCarNo1: TStringField
      FieldName = 'InCarNo1'
      Size = 50
    end
    object qrySCNormalInImage2: TStringField
      FieldName = 'InImage2'
      Size = 300
    end
    object qrySCNormalInCarNo2: TStringField
      FieldName = 'InCarNo2'
      Size = 50
    end
    object qrySCNormalInIOStatusNo: TWordField
      FieldName = 'InIOStatusNo'
    end
    object qrySCNormalOutUnitNo: TSmallintField
      FieldName = 'OutUnitNo'
    end
    object qrySCNormalOutDate: TStringField
      FieldName = 'OutDate'
      FixedChar = True
      Size = 10
    end
    object qrySCNormalOutTime: TStringField
      FieldName = 'OutTime'
      FixedChar = True
      Size = 8
    end
    object qrySCNormalOutImage1: TStringField
      FieldName = 'OutImage1'
      Size = 300
    end
    object qrySCNormalOutCarNo1: TStringField
      FieldName = 'OutCarNo1'
      Size = 50
    end
    object qrySCNormalOutImage2: TStringField
      FieldName = 'OutImage2'
      Size = 300
    end
    object qrySCNormalOutCarNo2: TStringField
      FieldName = 'OutCarNo2'
      Size = 50
    end
    object qrySCNormalOutIOStatusNo: TWordField
      FieldName = 'OutIOStatusNo'
    end
    object qrySCNormalInRecog1: TWordField
      FieldName = 'InRecog1'
    end
    object qrySCNormalOutRecog1: TWordField
      FieldName = 'OutRecog1'
    end
    object qrySCNormalInRecog2: TWordField
      FieldName = 'InRecog2'
    end
    object qrySCNormalOutRecog2: TWordField
      FieldName = 'OutRecog2'
    end
    object qrySCNormalReserve1: TStringField
      FieldName = 'Reserve1'
      Size = 50
    end
    object qrySCNormalReserve2: TStringField
      FieldName = 'Reserve2'
      Size = 50
    end
    object qrySCNormalReserve3: TStringField
      FieldName = 'Reserve3'
      Size = 50
    end
    object qrySCNormalReserve4: TStringField
      FieldName = 'Reserve4'
      Size = 50
    end
    object qrySCNormalReserve5: TStringField
      FieldName = 'Reserve5'
      Size = 50
    end
  end
