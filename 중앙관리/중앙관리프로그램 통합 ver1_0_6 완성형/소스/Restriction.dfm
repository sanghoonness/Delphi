object frmRestriction: TfrmRestriction
  Left = 0
  Top = 0
  Caption = #51228#54620#44396#50669#49444#51221
  ClientHeight = 280
  ClientWidth = 635
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    Text = ''
    FullHeight = 200
    object dgRestriction: TDBAdvGrid
      Left = 1
      Top = 1
      Width = 639
      Height = 167
      ...
      Columns = <
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #51228#54620#44396#50669#48264#54840
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
        ...
        item
          ...
          CheckTrue = 'Y'
          Color = clWindow
          FieldName = 'RestrictionName'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #51228#54620#44396#50669#51060#47492
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
  ...
  object AdvPanel2: TAdvPanel
    ...
    Text = ''
    FullHeight = 200
    object edtRestrictionNo: TAdvSpinEdit
      Left = 84
      Top = 13
      Width = 120
      Height = 22
      Value = 0
      DateValue = 43469.615720405090000000
      HexValue = 0
      FocusColor = clAqua
      ...
      LabelCaption = #51228#54620#44396#50669#48264#54840
    ...
    object edtRestrictionName: TAdvEdit
      Left = 297
      Top = 14
      Width = 120
      Height = 20
      EmptyTextStyle = []
      FocusColor = clAqua
      LabelCaption = #51228#54620#44396#50669#51060#47492
      LabelPosition = lpLeftCenter
      LabelTransparent = True
      LabelFont.Charset = ANSI_CHARSET
      LabelFont.Color = clWindowText
  ...
  object qryRestriction: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'Select * from RestrictionInfo')
    Left = 48
    Top = 48
    object qryRestrictionRestrictionNo: TWordField
      FieldName = 'RestrictionNo'
    end
    object qryRestrictionRestrictionName: TStringField
      FieldName = 'RestrictionName'
      Size = 50
    end
    object qryRestrictionReserve1: TStringField
      FieldName = 'Reserve1'
      Size = 50
    end
    object qryRestrictionReserve2: TStringField
      FieldName = 'Reserve2'
      Size = 50
    end
    object qryRestrictionReserve3: TStringField
      FieldName = 'Reserve3'
      Size = 50
    end
    object qryRestrictionReserve4: TStringField
      FieldName = 'Reserve4'
      Size = 50
    end
    object qryRestrictionReserve5: TStringField
      FieldName = 'Reserve5'
      Size = 50
    end
  end
  object dsRestriction: TDataSource
    DataSet = qryRestriction
    Left = 48
    Top = 112
  end
