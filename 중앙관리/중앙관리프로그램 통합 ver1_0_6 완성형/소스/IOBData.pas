  ...
  try
    ...
    begin
      ...
      begin
        ...
        ExceptLogging('블랙리스트차량 입차 파일 확인1 File: ' + sInFile);
        ...
        begin
          try
            ...
            begin
              ExceptLogging('블랙리스트차량 입차 파일 확인2 File: ' + sInFile);
        ...
        begin
          ...
          ExceptLogging('블랙리스트차량 출차 파일 확인1 File: ' + sOutFile);
        ...
        begin
          try
            ...
            begin
              ExceptLogging('블랙리스트차량 출차 파일 확인2 File: ' + sOutFile);
