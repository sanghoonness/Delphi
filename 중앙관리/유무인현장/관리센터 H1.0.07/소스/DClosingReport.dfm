object frmDClosingReport: TfrmDClosingReport
  Left = 0
  Top = 0
  Caption = #51068#51068#51221#49328' '#47560#44048#45236#50669
  ClientHeight = 447
  ClientWidth = 1185
  Color = clBtnFace
    ...
    object DBAdvGrid1: TDBAdvGrid
      ...
      Columns = <
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #47560#44048#49884#51089#51068#51088
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = #44404#47548#52404
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #47560#44048#49884#51089#49884#44033
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = #44404#47548#52404
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #47560#44048#51333#47308#51068#51088
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = #44404#47548#52404
        ...
        item
          ...
          Font.Name = #44404#47548#52404
          Font.Style = []
          Header = #47560#44048#51333#47308#49884#44033
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = #44404#47548#52404
  ...
  object Panel3: TPanel
    ...
    object edtParkMoney: TAdvEdit
      ...
      EmptyTextStyle = []
      FocusColor = 16445929
      LabelCaption = #52509' '#51452#52264#44552#50529
      LabelPosition = lpLeftCenter
      LabelFont.Charset = DEFAULT_CHARSET
      LabelFont.Color = clWindowText
      LabelFont.Height = -11
    ...
    object edtHunul: TAdvEdit
      ...
      EmptyTextStyle = []
      FocusColor = 16445929
      LabelCaption = #52509' '#54980#48520#44552#50529
      LabelPosition = lpLeftCenter
      LabelFont.Charset = DEFAULT_CHARSET
      LabelFont.Color = clWindowText
      LabelFont.Height = -11
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43040.526155752310000000
    ...
    object Page2: TfrxReportPage
      ...
      object ReportTitle2: TfrxReportTitle
        ...
        object Memo45: TfrxMemoView
          ...
          Memo.UTF8W = (
            #51068#51068#51221#49328' '#47560#44048#45236#50669)
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object MasterData4: TfrxMasterData
        ...
        object Memo92: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDataset1."ProcDate"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo3: TfrxMemoView
          Left = 289.582870000000000000
          Top = 0.464535200000000000
          Width = 94.488188980000000000
          Height = 30.236240000000000000
          ShowHint = False
      ...
      object MasterData8: TfrxMasterData
        ...
        Width = 1046.929810000000000000
        DataSet = frmVanListSum.frxDBDataset1
        DataSetName = 'frxDBDataset1'
        RowCount = 0
      end
  ...
  object qryReport: TADOQuery
    ...
    SQL.Strings = (
        ...
        ' , A.CarNo, A.InDate, A.InTime, A.ProcDate, A.ProcTime, A.TotFee' +
        ', A.TotDC  '
      
        ' , case when B.HUBULMONEY IS null then 0 else B.HUBULMONEY end H' +
        'UBULMONEY   '
      ' , case when PayType=1 then RecvAmt else 0 end moneypay   '
      ' , case when PayType=2 then RecvAmt else 0 end cardpay   '
      ' , startDate, startTime, endDate, endTime'
      ' from    '
      ' '#9'TKProc A left outer join   '
      
        ' '#9'(select MIN(reserve9) startDate, MIN(reserve10) startTime, MAX' +
        '(reserve7) endDate, MAX(reserve8) endTime'
      
        ' '#9', UnitNo,TKNo,ProcDate,ProcTime,ChkClosing,sum(RealDCAmt) DCAM' +
        'T, sum(CONVERT(int, Reserve6)) HUBULMONEY from    '
      ' '#9'DCDetail   '
      ' group by UnitNo,TKNo,ProcDate,ProcTime,ChkClosing) B  '
        ...
        ' where A.Reserve6 between '#39'2017-10-30'#39' and '#39'2017-10-31'#39' order by' +
        ' ProcDate,ProcTime')
    Left = 145
    Top = 121
    object qryReportUNITNAME: TStringField
      FieldName = 'UNITNAME'
      ReadOnly = True
      Size = 50
    end
    object qryReportCarNo: TStringField
      FieldName = 'CarNo'
      Size = 50
    end
    object qryReportInDate: TStringField
      FieldName = 'InDate'
      FixedChar = True
      Size = 10
    end
    object qryReportInTime: TStringField
      FieldName = 'InTime'
      FixedChar = True
      Size = 8
    end
    object qryReportProcDate: TStringField
      FieldName = 'ProcDate'
      FixedChar = True
      Size = 10
    end
    object qryReportProcTime: TStringField
      FieldName = 'ProcTime'
      FixedChar = True
      Size = 8
    end
    object qryReportTotFee: TIntegerField
      FieldName = 'TotFee'
      DisplayFormat = '#,##0'
    end
    object qryReportTotDC: TIntegerField
      FieldName = 'TotDC'
      DisplayFormat = '#,##0'
    end
    object qryReportHUBULMONEY: TIntegerField
      FieldName = 'HUBULMONEY'
      ReadOnly = True
      DisplayFormat = '#,##0'
    end
    object qryReportmoneypay: TIntegerField
      FieldName = 'moneypay'
      ReadOnly = True
      DisplayFormat = '#,##0'
    end
    object qryReportcardpay: TIntegerField
      FieldName = 'cardpay'
      ReadOnly = True
      DisplayFormat = '#,##0'
    end
    object qryReportstartDate: TStringField
      FieldName = 'startDate'
      ReadOnly = True
      Size = 50
    end
    object qryReportstartTime: TStringField
      FieldName = 'startTime'
      ReadOnly = True
      Size = 50
    end
    object qryReportendDate: TStringField
      FieldName = 'endDate'
      ReadOnly = True
      Size = 50
    end
    object qryReportendTime: TStringField
      FieldName = 'endTime'
      ReadOnly = True
      Size = 50
    end
