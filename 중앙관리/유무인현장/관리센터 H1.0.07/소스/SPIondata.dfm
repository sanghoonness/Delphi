object frmSPIONData: TfrmSPIONData
  Left = 0
  Top = 188
  Caption = #52789#48324#51077#52636#45236#50669
  ClientHeight = 633
  ClientWidth = 1300
  Color = clBtnFace
    ...
    object Panel2: TPanel
      ...
      object cmbOutStatus: TComboBox
        ...
        Items.Strings = (
          ...
          #49324#51204#51221#49328#54980#47924#47308#52636#52264)
      end
  ...
  object qryIONData: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'Select * from SpecialIONData')
    Left = 63
    Top = 74
    object qryIONDataParkNo: TSmallintField
      FieldName = 'ParkNo'
    end
    object qryIONDataUnitNo: TSmallintField
      FieldName = 'UnitNo'
    end
    ...
    object qryIONDataCarType: TWordField
      FieldName = 'CarType'
    end
    object qryIONDataInImage1: TStringField
      FieldName = 'InImage1'
      Size = 300
    end
    object qryIONDataInCarNo1: TStringField
      FieldName = 'InCarNo1'
      Size = 50
    end
    ...
    object qryIONDataOutUnitNo: TSmallintField
      FieldName = 'OutUnitNo'
    end
    ...
    object qryIONDataOutImage1: TStringField
      FieldName = 'OutImage1'
      Size = 300
    end
    object qryIONDataOutCarNo1: TStringField
      FieldName = 'OutCarNo1'
      Size = 50
    end
    ...
    object qryIONDataInRecog1: TWordField
      FieldName = 'InRecog1'
    end
    object qryIONDataOutRecog1: TWordField
      FieldName = 'OutRecog1'
    end
    ...
    object qryIONDataFTPayGubun: TWordField
      FieldName = 'FTPayGubun'
    end
    object qryIONDataFTParkingMin: TIntegerField
      FieldName = 'FTParkingMin'
    end
    object qryIONDataFTYogum: TIntegerField
      FieldName = 'FTYogum'
    end
    object qryIONDataFTDate: TStringField
      FieldName = 'FTDate'
      FixedChar = True
      Size = 10
    end
    object qryIONDataFTTime: TStringField
      FieldName = 'FTTime'
      FixedChar = True
      Size = 8
    end
    object qryIONDataJasmineDCTime: TSmallintField
      FieldName = 'JasmineDCTime'
    end
    object qryIONDataJasmineYN: TWordField
      FieldName = 'JasmineYN'
    end
    ...
    object qryIONDataReserve6: TStringField
      FieldName = 'Reserve6'
      Size = 50
    end
    object qryIONDataReserve7: TStringField
      FieldName = 'Reserve7'
      Size = 50
    end
    object qryIONDataReserve8: TStringField
      FieldName = 'Reserve8'
      Size = 50
    end
    object qryIONDataReserve9: TStringField
      FieldName = 'Reserve9'
      Size = 50
    end
    object qryIONDataReserve10: TStringField
      FieldName = 'Reserve10'
      Size = 50
    end
    object qryIONDataCacaoDCNO: TIntegerField
      FieldName = 'CacaoDCNO'
    end
