...
begin
  try
    ...
    on E: Exception do ExceptLogging('TfrmBlackListInfo.btnDeleteClick: ' + aString(E.Message));
  end;
end;
...
procedure TfrmBlackListInfo.btnSaveClick(Sender: TObject);
begin
  with qryBlackList do
  begin
    Close;
    SQL.Clear;
    SQL.Add('update BlackList set RegReason = :N1 where BCarNo = :N2 ');
    Parameters.ParamByName('N1').Value:= edtReason.Text;
