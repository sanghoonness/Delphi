object frmDailyReport: TfrmDailyReport
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44181.664390914350000000
    ...
    Datasets = <
      ...
      item
        DataSet = fFeeItemClosing2
        DataSetName = 'FeeItemClosing2'
      end
      item
        DataSet = fFeeItemClosing3
        DataSetName = 'FeeItemClosing3'
      end
      item
        DataSet = fFeeItemClosing4
        DataSetName = 'FeeItemClosing4'
      end
      item
      ...
      item
        DataSet = fTKProcClosing2
        DataSetName = 'TKProcClosing2'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[TKProcClosing."Reserve2"]'#50896)
          ParentFont = False
          Wysiwyg = False
          VAlign = vaCenter
        end
        object Memo16: TfrxMemoView
          Left = 732.850811100000000000
          Width = 75.590551180000000000
          Height = 30.236220470000000000
          DataSet = fTKProcClosing
          DataSetName = 'TKProcClosing'
      ...
      object Header3: TfrxHeader
        ...
        object Memo145: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            #49888#50857#52852#46300#44148#49688)
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object MasterData2: TfrxMasterData
        ...
        object Memo147: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing2."CountCash"]'#44148)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo148: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing2."CountCashAmt"]'#50896)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo149: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing2."CountCredit"]'#44148)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo150: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing2."CountCreditAmt"]'#50896)
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object MasterData9: TfrxMasterData
        ...
        object Memo136: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[TKProcClosing2."ProcRealFee"]'#50896)
          ParentFont = False
          Wysiwyg = False
          VAlign = vaCenter
        end
      ...
      object MasterData10: TfrxMasterData
        ...
        object Memo157: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing3."CountCash"]'#44148)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo158: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing3."CountCashAmt"]'#50896)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo159: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing3."CountCredit"]'#44148)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo160: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing3."CountCreditAmt"]'#50896)
          ParentFont = False
          VAlign = vaCenter
        end
      end
      object MasterData11: TfrxMasterData
        ...
        object Memo167: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing4."CountCash"]'#44148)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo168: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing4."CountCashAmt"]'#50896)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo169: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing4."CountCredit"]'#44148)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo170: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[FeeItemClosing4."CountCreditAmt"]'#50896)
          ParentFont = False
          VAlign = vaCenter
        end
      end
    ...
    object Page2: TfrxReportPage
      ...
      object Footer3: TfrxFooter
        ...
        object Memo91: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<TKProcClosing."ProcRealFee">,MasterData1)]'#50896)
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object fFeeItemClosing: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'COLUMN2=COLUMN2'
      'CountCash=CountCash'
      'CountCashAmt=CountCashAmt'
      'CountCredit=CountCredit'
      'CountCreditAmt=CountCreditAmt')
    OpenDataSource = False
    DataSource = dsFeeItemClosing
    BCDToCurrency = False
    Left = 400
  ...
  object qryTKProcClosing2: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
    ...
    Left = 696
    Top = 280
    object qryTKProcClosing2ProcCnt: TIntegerField
      FieldName = 'ProcCnt'
    end
    object qryTKProcClosing2ProcFee: TIntegerField
      FieldName = 'ProcFee'
    end
    object qryTKProcClosing2ProcRealFee: TIntegerField
      FieldName = 'ProcRealFee'
    end
    object qryTKProcClosing2LostCnt: TIntegerField
      FieldName = 'LostCnt'
    end
    object qryTKProcClosing2LostAmt: TIntegerField
      FieldName = 'LostAmt'
    end
    object qryTKProcClosing2DCCnt: TIntegerField
      FieldName = 'DCCnt'
    end
    object qryTKProcClosing2GT1Cnt: TIntegerField
      FieldName = 'GT1Cnt'
    end
    object qryTKProcClosing2ProcDC: TIntegerField
      FieldName = 'ProcDC'
    end
    object qryTKProcClosing2Reserve2: TIntegerField
      FieldName = 'Reserve2'
    end
    object qryTKProcClosing2Reserve4: TIntegerField
      FieldName = 'Reserve4'
    end
  end
  object fTKProcClosing2: TfrxDBDataset
    UserName = 'TKProcClosing2'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ProcCnt=ProcCnt'
      'ProcFee=ProcFee'
      'ProcRealFee=ProcRealFee'
      'LostCnt=LostCnt'
      'LostAmt=LostAmt'
      'DCCnt=DCCnt'
      'GT1Cnt=GT1Cnt'
      ...
      'Reserve4=Reserve4')
    OpenDataSource = False
    DataSource = dsTKProcClosing2
    BCDToCurrency = False
    Left = 784
    Top = 280
  end
  object dsTKProcClosing2: TDataSource
    DataSet = qryTKProcClosing2
    Left = 696
    Top = 328
  end
  object qryFeeItemClosing2: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
    ...
    object IntegerField4: TIntegerField
      FieldName = 'CountCashAmt'
    end
    object IntegerField5: TIntegerField
      FieldName = 'CountCredit'
    end
    object IntegerField6: TIntegerField
      FieldName = 'CountCreditAmt'
    end
  end
  object dsFeeItemClosing2: TDataSource
    DataSet = qryFeeItemClosing2
    Left = 664
    Top = 88
  end
  object fFeeItemClosing2: TfrxDBDataset
    UserName = 'FeeItemClosing2'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ProcDate=ProcDate'
      'FeeNo=FeeNo'
      ...
      'CountCreditAmt=CountCreditAmt')
    OpenDataSource = False
    DataSource = dsFeeItemClosing2
    BCDToCurrency = False
    Left = 664
    Top = 128
  end
  object qryFeeItemClosing3: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
  ...
  object dsFeeItemClosing3: TDataSource
    DataSet = qryFeeItemClosing3
    Left = 752
    Top = 88
  end
  object fFeeItemClosing3: TfrxDBDataset
    UserName = 'FeeItemClosing3'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ProcDate=ProcDate'
      'FeeNo=FeeNo'
      ...
      'CountCreditAmt=CountCreditAmt')
    OpenDataSource = False
    DataSource = dsFeeItemClosing3
    BCDToCurrency = False
    Left = 752
    Top = 128
  end
  object qryFeeItemClosing4: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
  ...
  object dsFeeItemClosing4: TDataSource
    DataSet = qryFeeItemClosing4
    Left = 832
    Top = 88
  end
  object fFeeItemClosing4: TfrxDBDataset
    UserName = 'FeeItemClosing4'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ProcDate=ProcDate'
      'FeeNo=FeeNo'
  ...
  object ADOQuery3: TADOQuery
    ...
    object IntegerField27: TIntegerField
      FieldName = 'FreeCarCount'
    end
    object IntegerField28: TIntegerField
      FieldName = 'FreeCarMoney'
    end
