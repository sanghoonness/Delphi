...
begin
  ...
  begin
    ...
    Close;
    SQL.Clear;
    SQL.Add('select A.UnitNo UnitNo,Max(B.UnitName) UnitName From IOSData A ,UnitInfo B where A.UnitNo<>0 and A.UnitNo=B.UnitNo and B.UnitKind<>13 and A.ParkNo=:N1 group by A.UnitNo  ');
