object frmUnitReport: TfrmUnitReport
  Left = 0
  Top = 0
  Caption = #51109#48708#48324' '#47560#44048#45236#50669
  ClientHeight = 385
  ClientWidth = 1022
  Color = clBtnFace
  ...
  object qryReport: TADOQuery
    ...
    SQL.Strings = (
        ...
        ' select (select UnitName from UnitInfo K where K.UnitNo=F.UnitNo' +
        ') unitname '
      '    ,SUM(F.TotFee) ParkMoney  '
      '    ,SUM(F.TotDC) DiscountMoney '
      ''
      '    ,SUM( F.moneypay)  moneypay  '
      '    ,SUM( F.cardpay) cardpay   '
      
        '    , MIN(startDate) startDate, MIN(startTime)  startTime, MAX(e' +
        'ndDate) endDate, MAX(endTime)  endTime'
      ' from    '
      ' (select A.UnitNo, A.CarNo,A.ProcDate   '
      '     ,A.ProcTime,A.TotFee,A.TotDC  '
      ''
      ...
      ' TKProc A left outer join   '
        ...
        ' (select  MIN(reserve9) startDate, MIN(reserve10) startTime, MAX' +
        '(reserve7) endDate, MAX(reserve8) endTime'
      
        ' , UnitNo,TKNo,ProcDate,ProcTime,ChkClosing,sum(RealDCAmt) DCAMT' +
        ' from  '
      '  DCDetail  '
      ...
      ' where A.Reserve6 between '#39'2017-10-31'#39' and '#39'2017-10-31'#39' ) F   '
      ' group by F.UnitNo   '
      ' order by UnitNo')
    Left = 145
    Top = 113
    ...
    object qryReportParkMoney: TIntegerField
      FieldName = 'ParkMoney'
      ReadOnly = True
      DisplayFormat = '#,##0'
    end
    object qryReportDiscountMoney: TIntegerField
      FieldName = 'DiscountMoney'
      ReadOnly = True
      DisplayFormat = '#,##0'
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43679.697397766210000000
    ...
    object Page2: TfrxReportPage
      ...
      object ReportTitle2: TfrxReportTitle
        ...
        object Memo45: TfrxMemoView
          ...
          Memo.UTF8W = (
            #51109#48708#48324' '#47560#44048#45236#50669)
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object Header2: TfrxHeader
        ...
        object Memo12: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            #47560#44048#49884#51089#51068#51088)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo16: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            #47560#44048#51333#47308#51068#51088)
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo17: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            #47560#44048#51333#47308#49884#44033)
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object MasterData4: TfrxMasterData
        ...
        object Memo92: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset2."moneypay"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo3: TfrxMemoView
          Left = 608.063390000000000000
          Top = 0.464535200000000000
          Width = 128.503963860000000000
          Height = 30.236240000000000000
          DataField = 'DiscountMoney'
          DataSet = frxDBDataset2
          DataSetName = 'frxDBDataset2'
          DisplayFormat.ThousandSeparator = ','
          DisplayFormat.FormatStr = '%2.0n'
        ...
        object Memo7: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset2."cardpay"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo13: TfrxMemoView
          Left = 196.535560000000000000
          Top = 0.354298980000000000
          Width = 94.488188980000000000
          Height = 30.236220470000000000
          DataField = 'startDate'
          DataSet = frxDBDataset2
