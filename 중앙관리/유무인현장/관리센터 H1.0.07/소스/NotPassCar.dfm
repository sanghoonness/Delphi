object frmNotPassCar: TfrmNotPassCar
  Left = 0
  Top = 0
  Caption = #48120#51221#49328#52636#52264#52264#47049
  ClientHeight = 477
  ClientWidth = 1067
  Color = clBtnFace
  ...
  object Panel3: TPanel
    ...
    object edtTotal: TPanel
      ...
      Caption = '  '#52509#44148#49688': 0'#44148
      TabOrder = 3
    end
  ...
  object qryNotPassCar: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      
        'select A.UnitNo,B.UnitName, ProcDate,ProcTime,CarNo,Image from n' +
        'otpasscar A,UnitInfo B'
      'where A.unitNo=B.unitNO')
    Left = 48
    Top = 76
    object qryNotPassCarUnitNo: TSmallintField
      FieldName = 'UnitNo'
    end
    object qryNotPassCarUnitName: TStringField
      FieldName = 'UnitName'
      Size = 50
    end
    object qryNotPassCarProcDate: TStringField
      FieldName = 'ProcDate'
      FixedChar = True
      Size = 10
    end
    object qryNotPassCarProcTime: TStringField
      FieldName = 'ProcTime'
      FixedChar = True
      Size = 8
    end
    object qryNotPassCarCarNo: TStringField
      FieldName = 'CarNo'
      Size = 50
    end
    object qryNotPassCarImage: TStringField
      FieldName = 'Image'
      Size = 300
    end
  end
  object dsNotPassCar: TDataSource
    DataSet = qryNotPassCar
    Left = 120
    Top = 76
  end
