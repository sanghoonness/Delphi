object frmCustInfo: TfrmCustInfo
  ...
  object AdvPanel2: TAdvPanel
    ...
    object edtCurrAmt: TAdvSpinEdit
      ...
      IncrementFloatPage = 1.000000000000000000
      LabelAlwaysEnabled = True
      LabelCaption = #50900#51221#44552#50529
      LabelPosition = lpLeftCenter
      LabelTransparent = True
      LabelFont.Charset = ANSI_CHARSET
      LabelFont.Color = clWindowText
    ...
    object cmbPayType: TAdvComboBox
      ...
      LabelCaption = #54032#47588#48169#49885
      LabelPosition = lpLeftCenter
      LabelTransparent = True
      LabelAlwaysEnabled = True
      LabelFont.Charset = ANSI_CHARSET
    ...
    object btnAdd3Month: TButton
      Left = 607
      Top = 117
      Width = 98
      Height = 28
      Caption = #44060#50900#50672#51109
      TabOrder = 29
      OnClick = btnAdd3MonthClick
    end
    ...
    object edtDeptName: TAdvEdit
      ...
      Text = ''
      Visible = True
      OnClick = edtDeptNameClick
      Version = '3.3.2.0'
    end
    object edtChangeGroupNo: TAdvEdit
      Left = 805
      Top = 118
      Width = 120
      Height = 20
  ...
  object btnSeek: TBitBtn
    ...
    Width = 97
    Height = 35
    Caption = #51312'  '#54924'('#44060#51064')'
    Glyph.Data = {
  ...
  object btnSetConfirm: TBitBtn
    ...
    Caption = #49688'  '#51221
    TabOrder = 9
    OnClick = btnSetConfirmClick
  end
  object btnSeekAll: TBitBtn
    Left = 618
    Top = 531
    Width = 97
    Height = 35
    Caption = #51312'  '#54924'('#51204#52404')'
    Glyph.Data = {
      76060000424D7606000000000000360400002800000018000000180000000100
      08000000000040020000130B0000130B000000010000000100005A6B7300AD7B
      73004A637B00EFBD8400B58C8C00A5948C00C6948C00B59C8C00BD9C8C00BD94
