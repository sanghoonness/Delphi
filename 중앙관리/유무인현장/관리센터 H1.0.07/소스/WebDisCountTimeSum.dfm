object frmWebDCTimeSum: TfrmWebDCTimeSum
  Left = 0
  Top = 0
  Caption = #54624#51064#45236#50669#51665#44228
  ClientHeight = 434
  ClientWidth = 819
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtDCTime: TAdvSpinEdit
      ...
      Height = 19
      Value = 0
      DateValue = 42724.447091481480000000
      HexValue = 0
      FocusColor = clAqua
      Font.Charset = ANSI_CHARSET
      Font.Color = 7485192
    ...
    object DBAdvGrid1: TDBAdvGrid
      ...
      Columns = <
        ...
        item
          ...
          Font.Name = 'Tahoma'
          Font.Style = []
          Header = #52509' '#54624#51064#54943#49688
          HeaderFont.Charset = DEFAULT_CHARSET
          HeaderFont.Color = clWindowText
          HeaderFont.Height = -11
          HeaderFont.Name = 'Tahoma'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42724.655031122680000000
    ...
    object Page2: TfrxReportPage
      ...
      object ReportTitle2: TfrxReportTitle
        ...
        object Memo45: TfrxMemoView
          ...
          Memo.UTF8W = (
            #54624' '#51064' '#45236' '#50669' '#51665' '#44228)
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object qryDCDetail: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select t.CarNo, COUNT(*) cnt, SUM(realdcmin) totalDC'
      ' from TKProc t      '
      ' left outer join DCDetail d on t.TKNo = d.TKNo     '
      ' left outer join UnitInfo u on t.UnitNo = u.UnitNo     '
      
        ' where t.ProcDate+t.ProcTime between '#39'2016-12-1500:00:00'#39' and '#39'2' +
        '016-12-1523:59:59'#39
      ' and t.CarNo  like '#39'%%'#39
      ' and RealDcMin > 0'
      ' group by t.CarNo')
    Left = 33
    Top = 121
    ...
    object qryDCDetailcnt: TIntegerField
      FieldName = 'cnt'
      ReadOnly = True
    end
    object qryDCDetailtotalDC: TIntegerField
      FieldName = 'totalDC'
      ReadOnly = True
    end
  end
