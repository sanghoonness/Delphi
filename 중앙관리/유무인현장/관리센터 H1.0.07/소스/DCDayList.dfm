object frmDCDayList: TfrmDCDayList
  Left = 0
  Top = 0
  Caption = #49464#45824#48324' '#54624#51064#45236#50669'('#51452#52264#51068#49688')'
  ClientHeight = 401
  ClientWidth = 659
  Color = clBtnFace
  ...
  object dgDCDay: TDBAdvGrid
    ...
    Columns = <
      ...
      item
        ...
        Font.Name = #44404#47548#52404
        Font.Style = []
        Header = #52509#51452#52264#51068#49688
        HeaderFont.Charset = DEFAULT_CHARSET
        HeaderFont.Color = clWindowText
        HeaderFont.Height = -12
        HeaderFont.Name = #44404#47548#52404
  ...
  object Panel1: TPanel
    ...
    object edtDCDay: TAdvSpinEdit
      Left = 580
      Top = 15
      Width = 66
      Height = 21
      Value = 0
      DateValue = 42755.659023032410000000
      HexValue = 0
      FocusColor = clAqua
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      ...
      LabelCaption = #51452#52264#51068#49688
      LabelPosition = lpLeftCenter
      LabelFont.Charset = DEFAULT_CHARSET
      LabelFont.Color = clWindowText
      LabelFont.Height = -13
  ...
  object dsDCDay: TDataSource
    DataSet = qryDCDay
    Left = 128
    Top = 76
  end
  object qryDCDay: TADOQuery
    Connection = dmTables.ADODB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      ' select * from (  '
      'select SUMK.StoreName StoreName, SUMK.CarNumber'
      ',SUM(SUMK.RealDcDay) RealDcDay'
      'from('#9
      
        #9'select A.StoreName StoreName,A.CarNumber CarNumber,B.RealDcDay ' +
        'RealDcDay,B.RealDcMin RealDcMin'
      #9'from( '
      #9#9'select StoreName,CarNumber,InYMD,InHMS,OutYmd,OutHms'
      #9#9',DiscountName,NorKey,DiscountCode ,Reserve4, Reserve5'
      #9#9'from tblStoreDiscountPublish'
      #9#9'where (OutYmd between '#39'2016-01-20'#39' and '#39'2017-01-20'#39') '
      #9#9'-- and StoreID ='#39'fox1'#39'  '
      #9#9'and DelYn=0                           '
      #9') A'
      
        #9',(  select DCNo,TKNo,CarNo,Reserve1,ProcDate,ProcTime,RealDcDay' +
        ',RealDcMin'
      #9#9'from DCDetail     '
      #9#9'where (ProcDate between '#39'2016-01-20'#39' and '#39'2017-01-20'#39') '
      #9') B'
      'where A.NorKey = B.TKNo'
      'and A.Reserve5 = B.Reserve1'
      'and A.OutYmd = B.ProcDate'
      'and A.OutHms = B.ProcTime '
      ') SUMK'
      'Group by SUMK.StoreName,SUMK.CarNumber'
      ' ) K'
      ' where k.RealDcDay >= 1')
    Left = 48
    Top = 76
    object qryDCDayStoreName: TStringField
      FieldName = 'StoreName'
      Size = 60
    end
    object qryDCDayCarNumber: TStringField
      FieldName = 'CarNumber'
    end
    object qryDCDayRealDcDay: TIntegerField
      FieldName = 'RealDcDay'
      ReadOnly = True
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42755.658994780090000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          Memo.UTF8W = (
            #49464#45824#48324' '#54624#51064#45236#50669'('#51452#52264#51068#49688')')
          ParentFont = False
          VAlign = vaCenter
        end
