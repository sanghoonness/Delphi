object frmWebDCReport: TfrmWebDCReport
  Left = 0
  Top = 0
  Caption = #50629#52404#48324' '#54980#48520' '#47560#44048#45236#50669
  ClientHeight = 532
  ClientWidth = 827
  Color = clBtnFace
  ...
  object edtTotalCnt: TAdvEdit
    ...
    EmptyTextStyle = []
    FocusColor = 16445929
    LabelCaption = #52509' '#54624#51064#54943#49688
    LabelPosition = lpLeftCenter
    LabelFont.Charset = DEFAULT_CHARSET
    LabelFont.Color = clWindowText
    LabelFont.Height = -11
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42600.629746932870000000
    ...
    object Page2: TfrxReportPage
      ...
      object ReportTitle2: TfrxReportTitle
        ...
        object Memo45: TfrxMemoView
          ...
          Memo.UTF8W = (
            #50629#52404#48324' '#54980#48520' '#47560#44048#45236#50669)
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object qryWebDC: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select F.storename,F.discountname,count(*) discountCount'
      '         ,SUM(F.DcAmt) discountMoney,sum(F.hubulmoney) hubul   '
      '  from         '
      
        #9'(select B.StoreName,B.DiscountName,A.DCAmt,CONVERT(int, B.Reser' +
        've7) DCMONEY, CONVERT(int, B.Reserve6) HUBULMONEY'
      #9' from DCDetail A left outer join'
      #9'      tblStoreDiscountPublish B'
      '     on A.TKNo =B.NorKey And A.Reserve1=B.Reserve5'
      
        '    where A.Reserve7 Between '#39'2016-08-17'#39' and'#9#39'2016-08-17'#39') F --' +
        ' '#47560#44048#44592#44036
      'group by F.StoreName,F.DiscountName   ')
    Left = 25
    Top = 121
    ...
    object qryWebDChubul: TIntegerField
      FieldName = 'hubul'
      ReadOnly = True
      DisplayFormat = '#,##0'
    end
